...
function prism(front, side, top, translate = [0, 0, 0]) {
    const f = (front || 1) / 2,
        s = (side || 1) / 2,
        t = (top || 1) / 2;
    let coords = [],
    ...
    face([-f, -s, t, f, -s, t, f, s, t, -f, s, t], [0, 0, 1]);
    face([-f, -s, -t, -f, s, -t, f, s, -t, f, -s, -t], [0, 0, -1]);

    face([-f, s, -t, -f, s, t, f, s, t, f, s, -t], [0, 1, 0]);
    face([-f, -s, -t, f, -s, -t, f, -s, t, -f, -s, t], [0, -1, 0]);

    face([f, -s, -t, f, s, -t, f, s, t, f, -s, t], [1, 0, 0]);
    face([-f, -s, -t, -f, -s, t, -f, s, t, -f, s, -t], [-1, 0, 0]);
